  ...
  return (
    <section id="about" className="py-20">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-right">
          About Me
        </h2>
        <p className="font-inter text-xl md:text-2xl lg:text-3xl text-gray-700 leading-relaxed max-w-3xl ml-auto text-right">
